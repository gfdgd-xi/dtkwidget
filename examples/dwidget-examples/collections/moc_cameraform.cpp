...
struct qt_meta_stringdata_CameraForm_t {
    QByteArrayData data[8];
    char stringdata0[145];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CameraForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CameraForm_t qt_meta_stringdata_CameraForm = {
    {
QT_MOC_LITERAL(0, 0, 10), // "CameraForm"
...
QT_MOC_LITERAL(6, 97, 23), // "on_pushButton_3_clicked"
QT_MOC_LITERAL(7, 121, 23) // "on_pushButton_4_clicked"

    },
    "CameraForm\0on_horizontalSlider_valueChanged\0"
...
static const uint qt_meta_data_CameraForm[] = {
...
QT_INIT_METAOBJECT const QMetaObject CameraForm::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CameraForm.data,
    qt_meta_data_CameraForm,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CameraForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraForm.stringdata0))
